...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let example_name = "trifurcation_bifurcation";
    ...
    let splits = [SplitType::Trifurcation, SplitType::Bifurcation];

    println!("Generating mixed geometry (trifurcation -> bifurcation)...");
